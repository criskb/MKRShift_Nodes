...
def build_material_spec(material_plan_path="", transport_plan_path="", endpoint_plan_path=""):
    return {
        "material_plan": _load_json(material_plan_path),
...
def build_playback_spec(image_plan_path="", start_frame=1, loop_mode="once", trigger_mode="manual"):
    return {
        "schema": "mkrshift_maya_playback_spec_v1",
        "image_output_plan": _load_json(image_plan_path),
