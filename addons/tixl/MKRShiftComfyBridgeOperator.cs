    ...
    public class MKRShiftComfyBridgeOperator
    {
        ...
        public Dictionary<string, object> BuildImagePayload(string packetPath, string preferredSlot = "")
        {
            ...
            return new Dictionary<string, object>
            {
                ...
                ["host"] = "tixl",
                ["packet"] = packet,
                ["preferredSlot"] = preferredSlot ?? string.Empty,
            };
        }
        ...
        public Dictionary<string, object> SubmitPayload(string endpointPlanPath, Dictionary<string, object> payload)
        {
            ...
            using var client = new HttpClient { Timeout = System.TimeSpan.FromMilliseconds(timeoutMs) };
            ...
            var body = JsonSerializer.Serialize(payload ?? new Dictionary<string, object>());
            using var content = new StringContent(body, Encoding.UTF8, "application/json");
            var response = client.PostAsync($"{baseUrl}{submitPath}", content).GetAwaiter().GetResult();
