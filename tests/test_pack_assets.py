...
class PackAssetTests(unittest.TestCase):
    ...
    def test_help_docs_exist_for_documented_nodes(self) -> None:
        ...
        expected = {
            ...
            "MKRNodeExtensionBuilderAdvanced.md",
            "MKRNodeExtensionBuilderPlan.md",
            "MKRNodeExtensionPyprojectPlan.md",
            "MKRPixelPaletteReduce.md",
            "MKRSpriteSheetExtract.md",
            "MKRJSONDiff.md",
            "MKRAddonStats.md",
            ...
            "x1ColorWheels.md",
            "x1Curves.md",
            "x1ColorWarpHueSat.md",
            "x1ColorWarpChromaLuma.md",
            "x1MaskGen.md",
            "x1Heatmap.md",
            "x1Heightmap.md",
            "x1RoughnessMap.md",
